      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-slate-200">
        ...
        <div className="p-6 space-y-5">
          <div className="flex items-center space-x-4 bg-slate-50 p-4 rounded-xl border border-slate-200">
            ...
            <div>
              <h2 className="text-lg font-extrabold text-slate-900 leading-snug">{officer.name || "Ward Officer"}</h2>
              <span className="inline-block mt-0.5 px-2 py-0.5 rounded text-[10px] font-bold bg-[#00355f] text-white">
                {officer.role || "Ward Officer"}
              </span>
          ...
          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between p-2.5 bg-slate-50 rounded-lg border border-slate-200">
              ...
              <span className="font-bold text-slate-900">{officer.department || "Roads & Highways"}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-50 rounded-lg border border-slate-200">
              ...
              <span className="font-bold text-slate-900">{officer.ward || "Ward 1 — RS Puram"}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-50 rounded-lg border border-slate-200">
              ...
              <span className="font-bold text-slate-900 font-mono text-[11px]">{officer.email || "officer@coimbatorecorp.gov.in"}</span>
            </div>
